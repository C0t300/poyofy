...
<html lang="en">
  <head>
    ...
    <?php
        ...
        $pdo = $db->connect();
        $songid = $_GET['songid'];
        $data = $db->getSongData($pdo, $songid); #{name, genre, length, ID_AC, publ}
        $data = $data[0];
        $name = $data[0];
        $genre = $data[1];
        $length = $data[2];
  ...
  <body>
    ...
    <div class="container">
        ...
        <h2 class="text-center"> Modificar Cancion<br> <small class="text-muted">Introduce solo lo que quieras cambiar</small> </h2>
        <form action="changesongback.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="genre" placeholder="<?php echo $genre; ?>">
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput1">Largo</label>
                    <input type="number"  class="form-control" name="length" placeholder="<?php echo $length; ?>">
                    <small id="lengthHelp" class="form-text text-muted">En segundos.</small>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput1">Fecha de Lanzamiento</label>
                    <input type="date"  class="form-control" name="date" placeholder="<?php echo $date; ?>">
                </div>
            ...
            <br>
            <a class="btn btn-danger" href='deletesong.php?songid= <?php echo $songid; ?>' role="button">Eliminar</a>
