...
<html lang="en">
  ...
  <body>
    ...
    <h3>Crea tu playlist!</h3>
        <form action="createplback.php" method="get">
            ...
            <div class="form-group">
                ...
                <textarea type="text" required="required" class="form-control" rows="3" name="desc"></textarea>
            </div>
